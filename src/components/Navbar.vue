...
<template>
  ...
  <nav
    class="flex-no-wrap relative flex w-full items-center justify-between bg-neutral-100 py-2 shadow-md shadow-black/5 dark:bg-fondo dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4"
    data-te-navbar-ref
  >
    <div class="flex w-full flex-wrap items-center justify-between px-3">
      ...
      >
        <!-- Logo -->
        <span class="mr-4 hidden text-white sm:block [&>svg]:w-7">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        >
          <!-- https://tailwindcomponents.com/component/search-input consultar-->
          <li class="mb-4 ml-8 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
            <input
              type="search"
              class="w-96 rounded border-0 bg-barra p-2"
      ...
      <div class="relative flex items-center">
        ...
        <div class="relative" data-te-dropdown-ref>
          ...
          >
            ...
            <!-- Usuario-->
            <a
              class="ml-4 mr-4 rounded-lg bg-gray-700 p-2 text-teal-400"
              href="#"
            >
              <span class="[&>svg]:w-5">
                <svg
